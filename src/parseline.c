...
static char *
strpbrk_escaped(const char *s, const char *cmd_delim, int *is_escaped) {
...
static int
split_cmds(char *line, vRawCmdLine *cmds) {
...
static int
parse_cmd(char *cmd, vcharptr_t *argv, char **infile, char **outfile, int *is_append) {
