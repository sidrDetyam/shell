...
static void
init_tty(struct termios *savtty) {
...
static void
backspace(char *input_buff, size_t *curr, size_t *rpos) {
...
static void
insert_character(char *input_buff, size_t *curr, size_t *rpos, char ch) {
...
static int
input_cmd(char *res, const char *original_cmd, int *is_up) {
    ...
    while (1) {
        ssize_t cnt = read(0, read_buff, MAX_SEQ_LEN);
