...
static int
intsfopen(const char *pathname, int flags, mode_t mode) {
    int fd;
...
static void
input_redirection(int oldfd, int newfd) {
...
static void
start_process(Process *p, pid_t pgid,
